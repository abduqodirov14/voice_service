...
async def voice_live_proxy(websocket: WebSocket):
    ...
    config = {
        ...
        MUHIM QOIDA: AGAR FOYDALANUVCHI GAPINGIZNI QAT'IY TO'XTATMASA, KICHIK SHOVQUINLARGA E'TIBOR BERMANG VA GAPINGIZNI OXIRIGACHA YETKAZING. 
        SIZ O'TA ASSERTV (O'ZIGA ISHONGAN) TIZIMSIZ.
